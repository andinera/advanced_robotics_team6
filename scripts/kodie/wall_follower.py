...
class Wall_Follower:
    ...
    def execute(self):
        ...
        if self.state == 'wall_follow':
            ...
            #corner near state
            if ir_bottom_error > 200 and ir_bottom_error < 1800 and ir_bottom_diff > 500 and self.imu_corner_pid.doorways_seen > self.doorways_seen_threshold and self.imu_corner_pid.turns_completed < 2:
            ...
            elif ir_bottom_error > self.bottom_c_min and ir_top_error > self.top_c_min and ir_top_error < self.top_c_max and imu_corner_pid.turns_completed < 2 and ir_top_diff < 100 and ir_bottom_diff > 1000:
            ...
            # either top or bottom IR has detected doorway
            elif ir_top_error > self.top_d_min and ir_top_diff > 50  or (ir_bottom_error > self.bottom_d_min and ir_bottom_error < self.bottom_d_max and ir_bottom_diff > 50):
                ...
                if ir_bottom_error < self.bottom_c_min and ir_top_error < self.top_c_min:
                ...
                elif ir_top_error > self.top_c_min:
                    self.ir_top_pid.ignore = True
            ...
            if ir_bottom_error > self.bottom_c_min and ir_top_error > self.top_c_min and ir_top_error < self.top_c_max and self.imu_corner_pid.turns_completed < 2 and ir_top_diff < 100 and ir_bottom_diff > 1000:
    		...
    		#enter corner
            if ir_bottom_error > self.bottom_c_min and ir_top_error > self.to_c_min and ir_top_error < self.top_c_max and self.imu_corner_pid.turns_completed < 2 and ir_top_diff < 100 and ir_bottom_diff > 1000:
                self.ir_bottom_pid.ignore = True
                self.ir_top_pid.ignore = True
                self.imu_wall_pid.ignore = True
                self.imu_corner_pid.ignore = False
                ...
                print "Exited Doorway with standard method"
    		#enter doorway
            elif ir_top_error > TOP_D_MIN and ir_top_diff > 50  or (ir_bottom_error > self.bottom_d_min and ir_bottom_error < self.bottom_d_max and ir_bottom_diff > 50):
        		if self.imu_corner_pid.accel_data_states[-1] < self.acceleration_min:
